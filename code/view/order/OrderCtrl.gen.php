...
if (\QWebRequest::IsAjaxCallback())
		...
		if (\QAutoload::$DebugPanel) $this->renderDebugInfo("/omi-frame-sample/code/view/order/OrderCtrl.details.tpl", "Generating (1) JS Functions to: /omi-frame-sample/code/view/order/OrderCtrl.js\n");
...
if (\QWebRequest::IsAjaxCallback())
		...
		if (\QAutoload::$DebugPanel) $this->renderDebugInfo("/omi-frame-sample/code/view/order/OrderCtrl.edit.tpl", "Generating (3) JS Functions to: /omi-frame-sample/code/view/order/OrderCtrl.js\n");
		?><!-- 
-->
...
if (\QWebRequest::IsAjaxCallback())
		...
		if (\QAutoload::$DebugPanel) $this->renderDebugInfo("/omi-frame-sample/code/view/order/OrderCtrl.item.tpl", "Generating (1) JS Functions to: /omi-frame-sample/code/view/order/OrderCtrl.js\n");
		?><!-- 
...
if (\QWebRequest::IsAjaxCallback())
		...
		if (\QAutoload::$DebugPanel) $this->renderDebugInfo("/omi-frame-sample/code/view/order/OrderCtrl.list.tpl", "");
...
if (\QWebRequest::IsAjaxCallback())
		...
		if (\QAutoload::$DebugPanel) $this->renderDebugInfo("/omi-frame-sample/code/view/order/OrderCtrl.tpl", "");
